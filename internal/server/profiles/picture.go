...
type pictureInputFn func(r *http.Request, cloudinaryService shared.CloudinaryService) (ProfilePicInput, error)

func CreatePictureHandler(
	storage ProfilePicStorage,
	authService shared.AuthRep,
	cloudinaryService shared.CloudinaryService,
	inputFn pictureInputFn,
) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		input, err := inputFn(r, cloudinaryService)
		if err != nil {
