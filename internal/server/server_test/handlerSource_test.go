...
func sourceInputFn(r *http.Request) (server.SourceInput, error) {
	return server.SourceInput{}, nil
}
...
func TestGetSourceInputBadLanguageID(t *testing.T) {
	...
	_, err := server.GetSourceInput(req)
	if err == nil {
...
func TestGetSourceInput(t *testing.T) {
	...
	req := formRequest("GET", "/", formValues)
	input, err := server.GetSourceInput(req)
	if err != nil {
		t.Error(err)
	}
...
func TestSourceHandlerBadInput(t *testing.T) {
	invalidInputFn := func(r *http.Request) (server.SourceInput, error) {
		return server.SourceInput{}, errors.New("error")
	}
	handler := server.CreateSourceHandler(sourceStorage{}, authRepo{}, invalidInputFn)
	if handler == nil {
...
func TestSourceHandlerBadStorage(t *testing.T) {
	handler := server.CreateSourceHandler(invalidSourceStorage{}, authRepo{}, sourceInputFn)
	if handler == nil {
		t.Error("expected handler")
	}
	req, _ := http.NewRequest("GET", "/", nil)
...
func TestSourceHandlerBadAuth(t *testing.T) {
	handler := server.CreateSourceHandler(sourceStorage{}, invalidAuthRepo{}, sourceInputFn)
	if handler == nil {
		t.Error("expected handler")
	}
	req, _ := http.NewRequest("GET", "/", nil)
...
func TestSourceHandler(t *testing.T) {
	handler := server.CreateSourceHandler(sourceStorage{}, authRepo{}, sourceInputFn)
	if handler == nil {
		t.Error("expected handler")
	}
	req, _ := http.NewRequest("GET", "/", nil)
