...
SELECT offer.id, offer.created_at, offer.updated_at, offer.title, offer.about, offer.requirements, offer.benefits, offer.min_wage, offer.max_wage, offer.company_id, offer.status, company.name as company_name, company.image_url as company_image_url
FROM offer
JOIN company ON offer.company_id = company.id
WHERE offer.id = ?
LIMIT 1
...
SELECT offer.id, offer.created_at, offer.updated_at, offer.title, offer.about, offer.requirements, offer.benefits, offer.min_wage, offer.max_wage, offer.company_id, offer.status
FROM offer
